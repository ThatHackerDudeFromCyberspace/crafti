...
static const BLOCK_WDATA user_selectable[] = {
    ...
    getBLOCKWDATA(BLOCK_STAIRS, 0b000000), // Stairs
    getBLOCKWDATA(BLOCK_STAIRS, 0b001000),
    getBLOCKWDATA(BLOCK_STAIRS, 0b010000),
    getBLOCKWDATA(BLOCK_STAIRS, 0b011000),
    getBLOCKWDATA(BLOCK_STAIRS, 0b100000),
    getBLOCKWDATA(BLOCK_STAIRS, 0b101000),
    getBLOCKWDATA(BLOCK_STAIRS, 0b110000),
    getBLOCKWDATA(BLOCK_STAIRS, 0b111000)
};
