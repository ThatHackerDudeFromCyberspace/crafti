...
void CactusRenderer::renderSpecialBlock(const BLOCK_WDATA block, GLFix x, GLFix y, GLFix z, Chunk &c)
{
    ...
    // If cactus not full, set "inside" to standard side
    TextureAtlasEntry cactus_inside = cactus_sid;
    ...
    cactus_vertices.push_back({GLFix(0) + cactus_size, GLFix(0) + cactus_height, GLFix(0) + cactus_offset, cactus_right_texturemap, cactus_sid.top, TEXTURE_TRANSPARENT});
    cactus_vertices.push_back({GLFix(0) + cactus_size, 0, GLFix(0) + cactus_offset, cactus_right_texturemap, cactus_sid.bottom, TEXTURE_TRANSPARENT});

    // Cactus Side
    cactus_vertices.push_back({GLFix(0) + cactus_size, 0, GLFix(0) - cactus_offset + BLOCK_SIZE, cactus_left_texturemap, cactus_sid.bottom, TEXTURE_TRANSPARENT});
    cactus_vertices.push_back({GLFix(0) + cactus_size, GLFix(0) + cactus_height, GLFix(0) - cactus_offset + BLOCK_SIZE, cactus_left_texturemap, cactus_sid.top, TEXTURE_TRANSPARENT});
    ...
    // Cactus (Front) Inside
    cactus_vertices.push_back({(GLFix(0) - cactus_offset) + cactus_size, 0, 0, cactus_inside.left, cactus_inside.bottom, TEXTURE_TRANSPARENT});
    cactus_vertices.push_back({(GLFix(0) - cactus_offset) + cactus_size, GLFix(0) + cactus_height, 0, cactus_inside.left, cactus_inside.top, TEXTURE_TRANSPARENT});
    cactus_vertices.push_back({(GLFix(0) - cactus_offset) + cactus_size, GLFix(0) + cactus_height, 0 + BLOCK_SIZE, cactus_inside.right, cactus_inside.top, TEXTURE_TRANSPARENT});
    cactus_vertices.push_back({(GLFix(0) - cactus_offset) + cactus_size, 0, 0 + BLOCK_SIZE, cactus_inside.right, cactus_inside.bottom, TEXTURE_TRANSPARENT});
    ...
    cactus_vertices.push_back({GLFix(0) + cactus_size - cactus_offset, GLFix(0) + cactus_height, GLFix(0) + BLOCK_SIZE - cactus_offset, cactus_top_texturemap, cactus_top.top, TEXTURE_TRANSPARENT});
    cactus_vertices.push_back({GLFix(0) + cactus_size - cactus_offset, GLFix(0) + cactus_height, GLFix(0) + cactus_offset, cactus_top_texturemap, cactus_top.bottom, TEXTURE_TRANSPARENT});
...
AABB CactusRenderer::getAABB(const BLOCK_WDATA block, GLFix x, GLFix y, GLFix z)
{
    ...
    {
        default:
            return {x + cactus_offset, y, z + cactus_offset + (cactus_width - cactus_size), x + cactus_offset + cactus_width, y + cactus_height, z + cactus_offset + cactus_width};
            break;
        case BLOCK_BACK:
            return {x + cactus_offset, y, z + cactus_offset, x + cactus_offset + cactus_width, y + cactus_height, z + cactus_offset +  cactus_size};
            break;
        case BLOCK_FRONT:
            return {x + cactus_offset, y, z + cactus_offset + (cactus_width - cactus_size), x + cactus_offset + cactus_width, y + cactus_height, z + cactus_offset + cactus_width};
            break;
        case BLOCK_LEFT:
            return {x + cactus_offset + (cactus_width - cactus_size), y, z + cactus_offset, x + cactus_offset + cactus_width, y + cactus_height, z + cactus_offset + cactus_width};
            break;
        case BLOCK_RIGHT:
            return {x + cactus_offset, y, z + cactus_offset, x + cactus_offset + cactus_size, y + cactus_height, z + cactus_offset + cactus_width};
            break;
    }
